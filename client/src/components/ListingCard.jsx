  ...
  <div class="relative mx-auto w-full">
	<a class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
	  <div class="shadow p-4 rounded-lg bg-white">
        ...
        <img src={data.imgUrls[0]} className='h-full' />
      </div>  
		  </div>
		  ...
		  <span class="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 text-sm font-medium text-white select-none" style={data.type=='Rent'?{backgroundColor:'red'}:{backgroundColor:'blue'}}>
			{data.type}
		  </span>
		</div>
		...
		<div class="mt-6">
		  <div class="flex justify-center">
			<p class="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl text-right">
